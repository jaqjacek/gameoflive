...
:: Android packaging
set AND_CERT_NAME="gameOfLive"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\gameOfLive.p12
...
set IOS_PROVISION=cert\gameOfLive.mobileprovision
...
set APP_ID=air.gameOfLive

:: Output packages
set DIST_PATH=dist
set DIST_NAME=gameOfLive
